export const reviews = [
    ...
    },
    {
        ...
        genre: "Drama",
        rating: "3",
        review: "A dark and gritty crime drama. The story was engaging, but the violence was a bit excessive. The acting was solid, though."
    },
    {
        title: "Mind-Bending Sci-Fi",
        genre: "Sci-Fi",
        rating: "4",
        review: "A complex and challenging sci-fi film that will leave you thinking. The plot was intricate, and the visuals were stunning. Not for casual viewers."
    },
    {
        title: "Over-the-Top Action",
        genre: "Action",
        rating: "3",
        review: "A pure action movie with lots of explosions and fight scenes. The plot was predictable, but the action was entertaining. Perfect for when you want to turn your brain off."
    },
    {
        title: "Touching Romantic Drama",
        genre: "Drama",
        rating: "5",
        review: "A beautiful and poignant romantic drama. The story was both heartwarming and heartbreaking, and the acting was superb. A must-see for fans of the genre."
    }
]